...
export async function syncUserAttributes(userId: string): Promise<void> {
  ...
  // Clear engine cache so next check uses fresh data
  engine.invalidate()
}
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// Example: hook into Stripe webhook for plan changes
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
export async function POST(req: Request) {
  ...
  switch (event.type) {
    case "customer.subscription.updated": {
      ...
      const newPlan = mapStripePlan(event.data.object.items.data[0].price.id);
      ...
      // Sync to access-engine (permissions update immediately)
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// Example: hook into admin action for org suspension
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
export async function POST(req: Request, ctx: { params: { id: string } }) {
  ...
  // Sync all users in the org — they'll be blocked by the "suspended-org" policy
